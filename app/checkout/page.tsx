...
export default function CheckoutPage() {
  ...
  // Initiate checkout when user clicks "Proceed to Payment"
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white border border-gray-200 p-6 rounded-lg">
            ...
            {/* Proceed to Payment button - only show if checkout not yet initiated */}
            {!checkoutData && (
              <div className="mt-6">
                <button
                ...
                {!isShippingValid && (
                  <p className="mt-2 text-sm text-gray-500">Please fill in all required fields (*)</p>
                )}
              </div>
            )}
          </div>
          ...
          <div className="space-y-6">
            {/* Order Summary - shows cart items before checkout, order details after */}
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              {checkoutData ? (
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-500">Complete shipping info to see order total</p>
                </div>
              )}
            </div>

            {/* Payment Form - only show after checkout is initiated */}
            {checkoutData && (
              <div className="bg-white border border-gray-200 p-6 rounded-lg">
